...
def postAlarm(cryptopair, triggerPrice, indexPrice, uid):
    addAlarm = "INSERT INTO alarms (id, userid, crypto, triggerprice, indexprice) VALUES (uuid(), %s, %s, %s, %s)"
    dataAlarm = (uid, cryptopair, triggerPrice, indexPrice)
